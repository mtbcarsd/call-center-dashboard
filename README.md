...
🎯 **Крупная задача на несколько будущих сессий** (согласована с пользователем,
2026-07-21, не начата) — миграция дашборда со Streamlit на Plotly Dash + три
ролевых дашборда (директор / начальник отдела / сотрудник с рекомендациями по
обучению). Детальный фазовый план — [DASH_MIGRATION_PLAN.md](DASH_MIGRATION_PLAN.md).
