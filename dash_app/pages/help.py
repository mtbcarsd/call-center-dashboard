...
_PAGES_TOUR = [
    ("📊", "Аналитика", "Фильтр периода со сравнением к предыдущему, hero-KPI, тренды по дням, проактивные алерты "
                          "«что требует внимания», лидерборд топ-3/анти-топ-3.", False),
    ...
    ("🧑‍💼", "Операторы", "Спарклайн тренда оценки и control chart по клику на оператора, донат проблемных звонков, "
                            "quick-stats шапка команды.", False),
...
_COMPARISON_ROWS = [
    ...
    ("Конструктор графиков", "❌", "Фиксированные страницы",
     "✅", "Drag-and-drop"),
    ("Геймификация/рейтинг среди коллег", "✅", "Лидерборд топ-3/анти-топ-3 с медалями на Аналитике и Операторах",
